...
/**
 * Cannot disseminate format exception.
 */
public final class CannotDisseminateFormatException extends ProtocolException {
  ...
  public CannotDisseminateFormatException(String message) {
    super(ErrorCode.cannotDisseminateFormat, message);
  }
  ...
  public CannotDisseminateFormatException(String message, Throwable cause) {
    super(ErrorCode.cannotDisseminateFormat, message, cause);
  }
}
