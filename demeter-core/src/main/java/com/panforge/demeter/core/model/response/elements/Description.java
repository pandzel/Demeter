...
public final class Description {
  ...
  public Description(OaiIdentifier oaiIdentifier) {
  ...
  public Description(RightsManifest rightsManifest) {
  ...
  public Description(EPrints eprints) {
  ...
  public Description(Friends friends) {
  ...
  public Description(Branding branding) {
  ...
  public Description(Gateway gateway) {
